        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Legenda = table.Column<string>(maxLength: 64, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Imagensid = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_NI", x => new { x.Imagensid, x.Noticiasid });
                    table.ForeignKey(
                        name: "FK_NI_Imagens_Imagensid",
                        column: x => x.Imagensid,
                        principalTable: "Imagens",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NI_Noticias_Noticiasid",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Noticiasid = table.Column<int>(nullable: false),
                    Topicosid = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_NT", x => new { x.Topicosid, x.Noticiasid });
                    table.ForeignKey(
